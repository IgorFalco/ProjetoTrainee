...
router.post("/create/:artistId", checkRole(Role.Admin), async (req: Request, res: Response, next: NextFunction) => { //considerando que a musica para ser adicionada tem que passar por um admin
	try {
...
router.put("/update/:musicId", checkRole(Role.Admin), async (req: Request, res: Response, next: NextFunction) => {
	try {
...
router.put("/updateListener/:musicId/:userId", checkRole(Role.Admin), async (req: Request, res: Response, next: NextFunction) => {
	try {
...
router.put("/updateMusicArtist/:musicId/:artistId", checkRole(Role.Admin), async (req: Request, res: Response, next: NextFunction) => {
	try {
...
router.delete("/delete/:musicId", checkRole(Role.Admin), async (req: Request, res: Response, next: NextFunction) => {
	try {
